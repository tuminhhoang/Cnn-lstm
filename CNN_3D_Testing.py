...
# Number of Locations in each class  ------------------------------
num_loc1 = 32
num_loc2 = 46
num_loc3 = 44
num_loc4 = 35
...
# Build a model 1 ---------------------------------
model1 = Sequential()
model1.add(Conv3D(3, (5, 5, 5), padding='same', input_shape=(num_timestep, ImageHeight, ImageWidth,ImageChannel), activation='relu'))
model1.add(keras.layers.BatchNormalization())
model1.add(Dropout(0.2))

model1.add(Conv3D(5, (5, 5, 5), padding='same', activation='relu')) # 5x90x90@3
# model.add(keras.layers.BatchNormalization())
model1.add(Dropout(0.2))

model1.add(MaxPooling3D(pool_size=(1,3,3), strides = (1,3,3), padding='same'))
model1.add(Conv3D(5, (5, 5, 5), padding='same', input_shape=(5, 5,30, 30), activation='relu'))
# model.add(keras.layers.BatchNormalization())

model1.add(MaxPooling3D(pool_size=(1,3,3), strides = (1,3,3), padding='same'))
model1.add(Conv3D(5, (5, 5, 5), padding='same', input_shape=(5, 5, 10, 10), activation='relu'))
# model.add(keras.layers.BatchNormalization())

model1.add(TimeDistributed(Flatten()))
model1.add(TimeDistributed(Dense(500, activation='relu')))
# model1.add(keras.layers.BatchNormalization())
model1.add(Dropout(0.2))
...
# Build a model 2 
model2 = Sequential()
model2.add(Conv3D(3, (5, 5, 5), padding='same', input_shape=(num_timestep, ImageHeight, ImageWidth,ImageChannel), activation='relu'))
model2.add(keras.layers.BatchNormalization())
model2.add(Dropout(0.2))

model2.add(Conv3D(5, (5, 5, 5), padding='same', activation='relu')) # 5x90x90@3
# model.add(keras.layers.BatchNormalization())
model2.add(Dropout(0.2))

model2.add(MaxPooling3D(pool_size=(1,3,3), strides = (1,3,3), padding='same'))
model2.add(Conv3D(5, (5, 5, 5), padding='same', input_shape=(5, 5,30, 30), activation='relu'))
# model.add(keras.layers.BatchNormalization())

model2.add(MaxPooling3D(pool_size=(1,3,3), strides = (1,3,3), padding='same'))
model2.add(Conv3D(5, (5, 5, 5), padding='same', input_shape=(5, 5, 10, 10), activation='relu'))
# model.add(keras.layers.BatchNormalization())

model2.add(TimeDistributed(Flatten()))
model2.add(TimeDistributed(Dense(500, activation='relu')))
# model2.add(keras.layers.BatchNormalization())
model2.add(Dropout(0.2))
...
# Build a model 2 
model3 = Sequential()
model3.add(Conv3D(3, (5, 5, 5), padding='same', input_shape=(num_timestep, ImageHeight, ImageWidth,ImageChannel), activation='relu'))
model3.add(keras.layers.BatchNormalization())
model3.add(Dropout(0.2))
ImageHeight
model3.add(Conv3D(5, (5, 5, 5), padding='same', activation='relu'))
model3.add(Dropout(0.2))

model3.add(MaxPooling3D(pool_size=(1,3,3), strides = (1,3,3), padding='same'))
model3.add(Conv3D(5, (5, 5, 5), padding='same', input_shape=(5, 5,30, 30), activation='relu'))
# model.add(keras.layers.BatchNormalization())

model3.add(MaxPooling3D(pool_size=(1,3,3), strides = (1,3,3), padding='same'))
model3.add(Conv3D(5, (5, 5, 5), padding='same', input_shape=(5, 5, 10, 10), activation='relu'))
# model.add(keras.layers.BatchNormalization())

model3.add(TimeDistributed(Flatten()))
model3.add(TimeDistributed(Dense(500, activation='relu')))
# model3.add(keras.layers.BatchNormalization())ImageHeight
model3.add(Dropout(0.2))
...
######################################################################
# Load Model
model1.load_weights("Database1.h5")
model2.load_weights("Database2.h5")
model3.load_weights("Database3.h5")
...
for CntTest in xrange(num_timestep,NumTestPoints):
    ...
    # ------------------------------------------
    for ii in xrange(num_timestep-1):
        for jj in xrange(ImageWidth*ImageChannel):
